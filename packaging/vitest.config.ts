 ...
 * decides in memory, and that was already false of `cli/` when it was written: those guards write files
 ...
 * seconds where `cli/` is seconds, so the two numbers differ by the order of magnitude the work does.
 */
