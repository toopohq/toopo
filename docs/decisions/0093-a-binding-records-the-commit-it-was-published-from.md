...
`string/slugify@1`'s frozen digest moved between `f4b8e0e` and `855a238`:

```
f4b8e0e   8bea4012754af625ac35b2a1283dbbc2e54e276df9a107133d82cc3e7a9feadf
855a238   8753bb972e614de3bdb6a4c27cd227d0a6bdc617c5ba5c6c5eabb392a23a78a1
```

The whole of what moved is `4a3bce5`, *docs: the threshold is reformulated, three rules leave their
...
Measured in a checkout, one perturbation at a time, on `string/slugify@1` at `855a238`:
