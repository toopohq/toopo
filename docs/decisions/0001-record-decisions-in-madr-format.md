...
Measured at `8f43fb5^`, over the 227 tracked `.ts` files: 19 887 lines of prose against 35 028 of code,
...
**Every row is stamped `8f43fb5^` because this record first published them unstamped, and the first row
...
behaviour this format rewards. Measured at `9426727`: `contract-record.ts` stood at a raw 0.276 and read
as a regression against the 0.24 it reached in `8f43fb5`, when twenty-six of its thirty-four prose lines
...
- The four worst files came down to a readable ratio with nothing deleted. Measured at `20f63c9`:
  ...
  `9426727` — nothing was deleted, 850 lines of prose moved.
