...
text of a whole record in bytes, divided by 1000, measured at `da0c3ca`** - the canonical text because
...
kibibyte called a kilobyte**. Re-measured at `c6592a2`, the commit that published them: the records
