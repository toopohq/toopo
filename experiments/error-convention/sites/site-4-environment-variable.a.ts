/**
 * Experiment material - site 4, convention A: an environment variable where absence and invalidity
...
export const resolvePort = (raw: string | undefined): number => {
  ...
  if (parsed === null) throw new Error(`PORT must be a number, received ${JSON.stringify(raw)}.`)
