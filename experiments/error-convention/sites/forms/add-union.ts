/**
 * Experiment material, and a verbatim copy of
 * `experiment/error-convention-round-2:contracts/date/add/reference.ts`. This folder exists only on
 * `experiment/error-convention-round-3` and disappears with it; nothing here is a contract, an
 * implementation or a registry test.
 *
 * date/add@1 as round 2 reported it: the reason travels inside the returned value.
 *
