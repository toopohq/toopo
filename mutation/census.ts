...
export const CENSUS: Readonly<Record<string, SuiteCensus>> = {
  [THE_CONTRACTS_SUITE]: {
    ...
    'contracts/typescript/object/deep-equal/profiles.test.ts': 7,
    'contracts/typescript/object/deep-equal/properties.test.ts': 12,
  ...
  'packages/registry/vitest.config.ts': {
    'packages/registry/address.test.ts': 4,
    'packages/registry/against-the-catalogue.test.ts': 70,
    'packages/registry/attestation.test.ts': 3,
    'packages/registry/coverage.test.ts': 28,
    ...
    'packages/registry/implementations.test.ts': 24,
    'packages/registry/response.test.ts': 68,
    ...
    'packages/registry/visibility.test.ts': 12,
  },
  ...
  'packages/cli/vitest.config.ts': {
    ...
    'packages/cli/where-a-file-may-land.test.ts': 5,
    'packages/cli/write.test.ts': 10,
  },
  ...
  'packages/site/vitest.config.ts': {
    ...
    'packages/site/pages.test.ts': 27,
    'packages/site/painting.test.ts': 3,
    'packages/site/playground.test.ts': 21,
    'packages/site/published-tree.test.ts': 11,
    'packages/site/read-literal.test.ts': 12,
  ...
  'packaging/vitest.config.ts': {
    ...
    'packaging/what-the-origin-lists.test.ts': 9,
    'packaging/what-the-product-imports.test.ts': 1,
  },
