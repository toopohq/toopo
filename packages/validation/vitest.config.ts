 ...
 *
 * This folder adds one of its own, and it is the loudest here. Every guard below spawns a TypeScript
 * compiler process to parse the files it analyses. Collected by `npm test`, that cost would be paid
