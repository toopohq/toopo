 ...
 * than the raw count suggests, and still **68 % of what the front page transfers**. Per page the
 * saving runs from 7 697 B on the method page to 7 974 B on a domain page, brotli being no more
 * linear than the pages are alike. Over the tree, 236 960 B against 118 759: half the HTML weight of
 * this site was the commentary of one stylesheet.
 *
 * ---------------------------------------------------------------------------
 ...
 * direction the argument already pointed.** Measured on the front page: inline costs 3 781 B where a
 * linked sheet costs 3 787 B on a first visit and 541 B on every page after it - so linking buys
 * 3 240 B per additional page, against one render-blocking round trip, one more address no listing
