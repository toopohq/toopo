...
This repository carries 19 mutation batteries. They inject **660 deliberate defects** into it — each
one a committed file naming the exact edit it makes and the verdict it must produce — and re-run the
whole suite once per defect. **625 are caught.** The 35 that survive are each classified, and the
