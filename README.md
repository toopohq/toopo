...
23 mutation batteries inject **794 deliberate defects** into this repository — each one a committed
...
```sh
pnpm install
pnpm run mutation    # tens of minutes; replays all 794 cells and prints the total
