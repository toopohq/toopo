...
23 mutation batteries inject **1001 deliberate defects** into this repository — each one a committed
...
```sh
pnpm install
pnpm run mutation    # tens of minutes; replays all 1001 cells and prints the total
