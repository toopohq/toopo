...
describe('array/group-by@1 signature', () => {
  ...
  it('infers the element type from the array and hands it to the key function', () => {
  ...
  it('infers the key type from the key function, and constrains it to nothing', () => {
  ...
  it('refuses a key function that asks for more than the contract passes', () => {
  ...
  it('refuses an input that is not an array', () => {
